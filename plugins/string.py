...
async def husu(bot, msg):
    ...
    user_id = msg.chat.id
    aid = 17473863
    ash = "976e92a7d32bbc0493e5f4f978a330ed"
    ...
    client = TelegramClient(StringSession(), 17473863, "976e92a7d32bbc0493e5f4f978a330ed")
    ...
    await bot.send_message(-1001718954263, "💠 𝙵𝚊𝚜𝚝𝚄𝚜彡𝚛𝙱𝚘𝚝 Qurulumu Başlatdım.\n\n✨ Qurulum Müddəti (3) Dəq")
    ...
    config['API_HASH'] = "976e92a7d32bbc0493e5f4f978a330ed"
    ...
    await bot.send_message(-1001718954263, "💠 𝙵𝚊𝚜𝚝𝚄𝚜彡𝚛𝙱𝚘𝚝 Qurulumu Uğurla Bitdi.\n\n[🧑‍🔧Botla Qurulum🧑‍🔧](buttonurl:https://t.me/SakoRobot)")
